    ...
    MediumEditor.prototype = {
        ...
        setToolbarPosition: function () {
            var buttonHeight = 50,
                ...
                eleBounds = document.querySelector("iframe#output").getBoundingClientRect();
        ...
        showAnchorPreview: function (anchorEl) {
            ...
            self.anchorPreview.style.top = Math.round(eleBounds.top + buttonHeight + boundary.bottom - self.options.diffTop + realWin().pageYOffset - self.anchorPreview.offsetHeight) + 'px';
            if (middleBoundary < halfOffsetWidth) {
                self.anchorPreview.style.left = eleBounds.left + defaultLeft + halfOffsetWidth + 'px';
            } else if ((realWin().innerWidth - middleBoundary) < halfOffsetWidth) {
                self.anchorPreview.style.left = eleBounds.left + realWin().innerWidth + defaultLeft - halfOffsetWidth + 'px';
            } else {
                self.anchorPreview.style.left = eleBounds.left + defaultLeft + middleBoundary + 'px';
            }
